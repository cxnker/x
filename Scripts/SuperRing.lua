...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.BackgroundColor3 = ringPartsEnabled and Color3.fromRGB(0,200,0) or Color3.fromRGB(32,34,37)
end)
...
local userId = Players:GetUserIdFromNameAsync("Roun95")
