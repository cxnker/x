...
Tab1:AddDiscordInvite({
    ...
    Logo = "rbxassetid://72831610283500",
    Invite = "Link discord invite",
})

local Section = Tab1:AddSection({"credits"})

local Paragraph = Tab1:AddParagraph({"versao ", "3.0"})

local Paragraph = Tab1:AddParagraph({"Oque ha de novo?🤔", "????????"})

local Paragraph = Tab1:AddParagraph({"usando", "Incomun Hub 3.0"})

local Paragraph = Tab1:AddParagraph({"Eventos", "off"})

local Paragraph = Tab1:AddParagraph({"discord", "124"})

  local Dialog = Window:Dialog({
    Title = "Aviso",
    Text = "ei ei calma ai. voce ja usou incomun Hub?",
    Options = {
      {"Sim!", function()
...
local Section = Tab2:AddSection({"Chat"})

Tab2:AddButton({"Chat Spy", function(Value)
--// Chat Incomum 🕴️ | Spy Chat para Brookhaven RP
...
MiniTab.Size = UDim2.new(0, 150, 0, 25)
MiniTab.Position = Frame.Position
MiniTab.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
MiniTab.TextColor3 = Color3.fromRGB(255, 255, 255)
MiniTab.Font = Enum.Font.GothamBold
MiniTab.TextSize = 14
MiniTab.Text = "📜 Chat Incomum"
MiniTab.Visible = false
MiniTab.Parent = ScreenGui

-- Tornar aba arrastável
local draggingMini, dragInputMini, dragStartMini, startPosMini
local function updateMini(input)
	local delta = input.Position - dragStartMini
	MiniTab.Position = UDim2.new(startPosMini.X.Scale, startPosMini.X.Offset + delta.X, startPosMini.Y.Scale, startPosMini.Y.Offset + delta.Y)
end
MiniTab.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		draggingMini = true
		dragStartMini = input.Position
		startPosMini = MiniTab.Position
		input.Changed:Connect(function()
			if input.UserInputState == Enum.UserInputState.End then
				draggingMini = false
			end
...
MiniTab.InputChanged:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
		dragInputMini = input
	end
end)
...
ChatBox.Size = UDim2.new(1, 0, 1, -25)
ChatBox.Position = UDim2.new(0, 0, 0, 25)
ChatBox.CanvasSize = UDim2.new(0, 0, 0, 0)
ChatBox.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
...
MiniTab.MouseButton1Click:Connect(function()
	Frame.Position = MiniTab.Position
	Frame.Visible = true
	MiniTab.Visible = false
end)
...
local function ConnectPlayer(plr)
	plr.Chatted:Connect(function(message)
		...
		if string.find(message:lower(), "/w") or string.find(message:lower(), "whisper") then
			StarterGui:SetCore("SendNotification", {
				Title = "Chat Incomum 🕴️",
				Text = "Mensagem sus encontrada",
				Duration = 5
			})
		end
	end)
...
AddMessage("✅ Chat Incomum 🕴️ iniciado!")
print("Hello World!")
end})

local Section = Tab2:AddSection({"Sharigam"})

Tab2:AddButton({"Sharigam", function(Value)
-- Serviços
local Players = game:GetService("Players")
...
-- Criar a interface gráfica com a imagem rotativa
local function createRotatingImage()
    -- Criar ScreenGui
    local screenGui = Instance.new("ScreenGui")
    ...
    -- Criar ImageLabel para a imagem
    local imageLabel = Instance.new("ImageLabel")
    imageLabel.Name = "IdiotImage"
    imageLabel.Size = UDim2.new(0, 200, 0, 200) -- Tamanho da imagem
    imageLabel.Position = UDim2.new(0.5, -100, 0.5, -100) -- Centralizado
    imageLabel.BackgroundTransparency = 1
    imageLabel.Image = "rbxassetid://139958375809767" -- ID da imagem
    imageLabel.Parent = screenGui

    -- Animação de rotação contínua
    local rotationSpeed = 360 -- Graus por segundo
    RunService.RenderStepped:Connect(function(deltaTime)
        imageLabel.Rotation = (imageLabel.Rotation + rotationSpeed * deltaTime) % 360
    end)
end

-- Criar luz vermelha forte
local function setStrongRedLight()
    -- Aguardar até que o personagem do jogador local esteja carregado
    if not LocalPlayer.Character or not LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        LocalPlayer.CharacterAdded:Wait()
    end

    -- Criar PointLight no HumanoidRootPart
    local pointLight = Instance.new("PointLight")
    pointLight.Name = "StrongRedLight"
    pointLight.Color = Color3.fromRGB(255, 0, 0) -- Vermelho puro
    pointLight.Brightness = 3 -- Alta intensidade (ajustável)
    pointLight.Range = 100 -- Grande alcance para iluminar o ambiente
    pointLight.Shadows = true -- Ativar sombras para maior realismo
...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/cxnker/x/refs/heads/main/Libs/TurtleUiLib.lua"))()
...
TrollTab:AddButton({
    Name = "[🌌🚀] Expansão de Domínio (by Vc777)",
...
if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then 
    TextChatService.TextChannels.RBXGeneral:SendAsync(
        "hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r[⚠️AVISO] UM TORNADO SURGIU! Vc777"
    )
else 
    print("Nadaa")
end
...
local Tab9 = Window:MakeTab({"Segurity", "shield"})
